...
namespace SecretMadonna.NEMS.Infrastructure.Common
{
    ...
    public sealed class SqlHelper
    {
        ...
        #endregion 私有构造函数,方法结束

        #region ExecuteNonQuery 命令
        /// <summary>
        ...
        #endregion ExecuteNonQuery 命令结束

        #region ExecuteDataset 数据集命令
        /// <summary>
        ...
        #endregion ExecuteDataset 数据集命令结束
        ...
        #endregion ExecuteReader 数据阅读器结束
        ...
        #endregion ExecuteXmlReader XML阅读器结束
